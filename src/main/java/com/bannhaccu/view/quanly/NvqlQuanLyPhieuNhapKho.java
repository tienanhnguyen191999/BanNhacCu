...
public class NvqlQuanLyPhieuNhapKho extends javax.swing.JFrame {
    ...
    /**
     * Creates new form NvqlQuanLyPhieuNhapKho
     */
    public NvqlQuanLyPhieuNhapKho(NhanVien nv) {
        initComponents();
        this.nv = nv;
    ...
    public void initTable() {
        ...
        ArrayList<PhieuNhapKho> arr_pnk = pnkDAO.getListPhieuNhapKho();
        ...
        for (PhieuNhapKho item : arr_pnk) {
            ...
            tableSanpham.getModel().setValueAt(item.getIs_check() == 0 ? "" : "X", index++, 4);
        }
    }
    ...
    private void initComponents() {
        ...
        tableSanpham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stt", "Mã Phiếu nhập kho", "Thời gian tạo", "Người tạo", "Trạng thái ( X ~ Đã nhập )"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (tableSanpham.getSelectedRow() != -1) {
            ...
            if (optionValue == 0) {
                ...
                pnkDAO.xoaPhieuNhapKho((int) dtm.getValueAt(tableSanpham.getSelectedRow(), 1));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (tableSanpham.getSelectedRow() != -1) {
            new NvqlPhieuNhapKhoChiTiet((int) tableSanpham.getModel().getValueAt(tableSanpham.getSelectedRow(), 1)).setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Hãy chọn 1 dòng");
        }
