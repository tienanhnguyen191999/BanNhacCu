...
public class NvqlQuanLySanPham extends javax.swing.JFrame {
     ...
     */
    public NvqlQuanLySanPham(NhanVien nv) {
        initComponents();
        this.nv = nv;
    ...
    public void initTable() {
        ...
        ArrayList<SanPham> arr_data = spDAO.getSanpham();

        int index = 0;
         DecimalFormat formatter = (DecimalFormat) NumberFormat.getInstance(Locale.US);
        formatter.applyPattern("#,###,###,###");
        for (SanPham item : arr_data) {
            Object[] emptyData = {null, null, null, null, null, null, null, null, null};
            ...
            tableSanpham.getModel().setValueAt(item.getTen(), index, 2);
            tableSanpham.getModel().setValueAt(item.getThongsokithuat(), index, 3);
            tableSanpham.getModel().setValueAt(item.getMota(), index, 4);
            tableSanpham.getModel().setValueAt(formatter.format(item.getGia()).toString(), index, 5);
            tableSanpham.getModel().setValueAt(item.getSoluong(), index, 6);
            tableSanpham.getModel().setValueAt(item.getTheloai().getTen(), index, 7);
            tableSanpham.getModel().setValueAt(item.getHang().getTen(), index++, 8);
        }
    }
    ...
    private void initComponents() {
        ...
        tableSanpham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stt", "Mã Sản phẩm", "Tên Sản phẩm", "Thông số kĩ thuật", "Mô tả", "Giá", "Tồn kho", "Thể loại", "Hãng"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class
            };
        ...
        if (tableSanpham.getColumnModel().getColumnCount() > 0) {
            tableSanpham.getColumnModel().getColumn(0).setMinWidth(30);
            ...
            tableSanpham.getColumnModel().getColumn(2).setMinWidth(200);
            tableSanpham.getColumnModel().getColumn(2).setPreferredWidth(200);
            tableSanpham.getColumnModel().getColumn(2).setMaxWidth(200);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new NvqlTaoMoiSanPham(nv).setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (tableSanpham.getSelectedRow() != -1) {
            ...
            if (optionValue == 0) {
                ...
                if(spDAO.xoaSanPham((int) dtm.getValueAt(tableSanpham.getSelectedRow(), 1))){
